...
public class ApiClientTPV1 {
    ...
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Collections.singletonList(
            new ServerConfiguration(
                    "https://your-protect-instance.example.com",
    ...
    private String basePath = "https://your-protect-instance.example.com";
     ...
     */
    public ApiClientTPV1(OkHttpClient client) {
        init();
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://your-protect-instance.example.com
     * @return An instance of OkHttpClient
     */
    public ApiClientTPV1 setBasePath(String basePath) {
    ...
    public ApiClientTPV1 setServers(List<ServerConfiguration> servers) {
    ...
    public ApiClientTPV1 setServerIndex(Integer serverIndex) {
    ...
    public ApiClientTPV1 setServerVariables(Map<String, String> serverVariables) {
     ...
     */
    public ApiClientTPV1 setHttpClient(OkHttpClient newHttpClient) {
     ...
     * @return Api client
     */
    public ApiClientTPV1 setJSON(JSON json) {
        this.json = json;
        return this;
    }
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 setVerifyingSsl(boolean verifyingSsl) {
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 setSslCaCert(InputStream sslCaCert) {
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 setKeyManagers(KeyManager[] managers) {
     ...
     * @return a {@link ApiClientTPV1} object
     */
    public ApiClientTPV1 setDateFormat(DateFormat dateFormat) {
     ...
     * @return a {@link ApiClientTPV1} object
     */
    public ApiClientTPV1 setSqlDateFormat(DateFormat dateFormat) {
     ...
     * @return a {@link ApiClientTPV1} object
     */
    public ApiClientTPV1 setOffsetDateTimeFormat(DateTimeFormatter dateFormat) {
     ...
     * @return a {@link ApiClientTPV1} object
     */
    public ApiClientTPV1 setLocalDateFormat(DateTimeFormatter dateFormat) {
     ...
     * @return a {@link ApiClientTPV1} object
     */
    public ApiClientTPV1 setLenientOnJson(boolean lenientOnJson) {
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 setUserAgent(String userAgent) {
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 addDefaultHeader(String key, String value) {
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 addDefaultCookie(String key, String value) {
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 setDebugging(boolean debugging) {
     ...
     * @return ApiClient
     */
    public ApiClientTPV1 setTempFolderPath(String tempFolderPath) {
     ...
     * @return Api client
     */
    public ApiClientTPV1 setConnectTimeout(int connectionTimeout) {
     ...
     * @return Api client
     */
    public ApiClientTPV1 setReadTimeout(int readTimeout) {
     ...
     * @return Api client
     */
    public ApiClientTPV1 setWriteTimeout(int writeTimeout) {
