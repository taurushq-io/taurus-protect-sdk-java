...
public class TgvalidatordCreateOutgoingXLMClawbackRequestRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fromAddressId, toAddressId, toWhitelistedAddressId, destinationAddressMemo, amount, feeLimit, comment, externalRequestId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TgvalidatordCreateOutgoingXLMClawbackRequestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TgvalidatordCreateOutgoingXLMClawbackRequestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
