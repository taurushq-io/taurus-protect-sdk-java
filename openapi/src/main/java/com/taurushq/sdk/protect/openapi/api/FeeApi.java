...
public class FeeApi {
    ...
    /**
     * Build call for feeServiceGetFees
     ...
     */
    public okhttp3.Call feeServiceGetFeesCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/rest/v1/fees";
    ...
    private okhttp3.Call feeServiceGetFeesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return feeServiceGetFeesCall(_callback);

    }

    /**
     * List fees
     * This endpoint returns a list of fees
     ...
     */
    public TgvalidatordGetFeesReply feeServiceGetFees() throws ApiException {
        ApiResponse<TgvalidatordGetFeesReply> localVarResp = feeServiceGetFeesWithHttpInfo();
     ...
     * List fees
     * This endpoint returns a list of fees
     * @return ApiResponse&lt;TgvalidatordGetFeesReply&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TgvalidatordGetFeesReply> feeServiceGetFeesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = feeServiceGetFeesValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<TgvalidatordGetFeesReply>(){}.getType();
     ...
     */
    public okhttp3.Call feeServiceGetFeesAsync(final ApiCallback<TgvalidatordGetFeesReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = feeServiceGetFeesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetFeesReply>(){}.getType();
