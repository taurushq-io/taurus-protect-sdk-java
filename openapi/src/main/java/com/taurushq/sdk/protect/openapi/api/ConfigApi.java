...
public class ConfigApi {
    ...
    /**
     * Build call for statusServiceGetConfigTenant
     ...
     */
    public okhttp3.Call statusServiceGetConfigTenantCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/rest/v1/config/tenant";
    ...
    private okhttp3.Call statusServiceGetConfigTenantValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return statusServiceGetConfigTenantCall(_callback);
     ...
     * @return TgvalidatordGetConfigTenantReply
     ...
     */
    public TgvalidatordGetConfigTenantReply statusServiceGetConfigTenant() throws ApiException {
        ApiResponse<TgvalidatordGetConfigTenantReply> localVarResp = statusServiceGetConfigTenantWithHttpInfo();
     ...
     * Get some configuration of the tenant
     * This endpoint return the configuration of the tenant of the connected user
     * @return ApiResponse&lt;TgvalidatordGetConfigTenantReply&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TgvalidatordGetConfigTenantReply> statusServiceGetConfigTenantWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = statusServiceGetConfigTenantValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<TgvalidatordGetConfigTenantReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get some configuration of the tenant (asynchronously)
     * This endpoint return the configuration of the tenant of the connected user
     ...
     */
    public okhttp3.Call statusServiceGetConfigTenantAsync(final ApiCallback<TgvalidatordGetConfigTenantReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = statusServiceGetConfigTenantValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetConfigTenantReply>(){}.getType();
